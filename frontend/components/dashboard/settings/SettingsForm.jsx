    ...
    if (loading) {
        return (
            <div className="mt-[20px] text-center py-10">
                <p className="text-text-secondary">جاري تحميل الإعدادات...</p>
            </div>
        );
    }
        ...
        <Section className="mt-[20px]">
            <form onSubmit={handleSubmit} className="flex flex-col gap-8">
                ...
                <div className="bg-card border border-border p-6 rounded-2xl">
                    <h3 className="text-lg font-bold mb-4 text-text-primary">المعلومات الأساسية</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label className="block text-sm text-text-secondary mb-1">اسم الموقع</label>
                        ...
                        <div>
                            <label className="block text-sm text-text-secondary mb-1">وصف الموقع</label>
                ...
                {/* Media */}
                <div className="bg-card border border-border p-6 rounded-2xl">
                    <h3 className="text-lg font-bold mb-4 text-text-primary">الصور والشعارات</h3>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div>
                            <label className="block text-sm text-text-secondary mb-1">الشعار الداكن</label>
                        ...
                        <div>
                            <label className="block text-sm text-text-secondary mb-1">الشعار الفاتح</label>
                        ...
                        <div>
                            <label className="block text-sm text-text-secondary mb-1">الأيقونة (Favicon)</label>
                ...
                {/* Contact Information */}
                <div className="bg-card border border-border p-6 rounded-2xl">
                    <h3 className="text-lg font-bold mb-4 text-text-primary">معلومات التواصل</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label className="block text-sm text-text-secondary mb-1">البريد الإلكتروني للدعم</label>
                        ...
                        <div>
                            <label className="block text-sm text-text-secondary mb-1">رقم هاتف الدعم</label>
                        ...
                        <div>
                            <label className="block text-sm text-text-secondary mb-1">واتساب</label>
                ...
                {/* Social Media Links */}
                <div className="bg-card border border-border p-6 rounded-2xl">
                    <h3 className="text-lg font-bold mb-4 text-text-primary">روابط التواصل الاجتماعي</h3>
                ...
                {/* SEO Config */}
                <div className="bg-card border border-border p-6 rounded-2xl">
                    <h3 className="text-lg font-bold mb-4 text-text-primary">إعدادات تحسين محركات البحث (SEO)</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label className="block text-sm text-text-secondary mb-1">عنوان SEO</label>
                        ...
                        <div>
                            <label className="block text-sm text-text-secondary mb-1">الكلمات المفتاحية (SEO Keywords) - مفصولة بفاصلة</label>
                            <input type="text" name="seoKeywordsString" value={formData.seoKeywordsString} onChange={handleChange} placeholder="مثال: تعليم, كورسات, أكاديمية" className="w-full h-12 rounded-xl border bg-background px-4 text-text-primary outline-none transition border-border focus:border-primary" />
                        </div>
                        <div className="md:col-span-2">
                            <label className="block text-sm text-text-secondary mb-1">وصف SEO</label>
                ...
                {/* Advanced Settings */}
                <div className="bg-card border border-border p-6 rounded-2xl">
                    <h3 className="text-lg font-bold mb-4 text-text-primary">إعدادات المنصة</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <div>
                            <label className="block text-sm text-text-secondary mb-1">العملة الافتراضية</label>
                        ...
                        <div>
                            <label className="block text-sm text-text-secondary mb-1">اللغة الافتراضية</label>
                    ...
                    <div className="flex items-center gap-4 border-t border-border pt-4">
                        <div className="flex items-center gap-2">
                            ...
                            <label htmlFor="allowRegistration" className="text-sm cursor-pointer select-none">السماح بتسجيل مستخدمين جدد</label>
                        </div>
                        <div className="flex items-center gap-2">
                            ...
                            <label htmlFor="maintenanceMode" className="text-sm cursor-pointer select-none">تفعيل وضع الصيانة</label>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex justify-end pt-4 pb-10">
                    <button type="submit" disabled={isPending} className="gradient-button px-8 py-3 rounded-xl text-white font-bold hover:opacity-90 transition shadow-lg shadow-primary/20 text-lg">
                        {isPending ? "جاري الحفظ..." : "حفظ إعدادات المنصة"}
                    </button>
                </div>
            </form>
        </Section>
